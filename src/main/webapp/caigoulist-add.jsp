                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">添加清单</h3></div>
                            <div class="panel-body">
                                <form action="${pageContext.request.contextPath}/clientPurchaseOrder/save" class="form-horizontal" >
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" >日期</label>
                                        <div class="col-md-10">
                                            <input type="date"  name="date" class="form-control" placeholder="日期">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <label>
                                                <input name="address" type="text" class="form-control" placeholder="发货地址">
                                            </label>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label">所属合同</label>
                                        <div class="col-md-10">
                                            <label>
                                                <input name="order_id" type="text" class="form-control" placeholder="所属合同ID">
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <select class="select2" multiple name="listGood" data-placeholder="选择已付款商品加入该采购清单">
                                               <c:forEach items="${sessionScope.aOrderGoods}" var="agoods" >
                                                    <option value="${agoods.goods_name}">${agoods.goods_name}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
