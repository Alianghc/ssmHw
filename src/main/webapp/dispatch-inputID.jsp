...
<head>
    ...
    <script >
        $(document).ready(function () {
            <%
               ...
               session.setAttribute("dispatchID",s);
           %>
    ...
    <body>
        ...
        <aside class="left-panel">
            ...
            <!-- brand -->
            <div class="logo">
                <a href="inindexWhManager.jsp" class="logo-expanded">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">请输入发货单的相关信息</h3></div>
                            <div class="panel-body">
                            
                                <form class="form-inline" action="/dispatch/confirm" role="form">
                                    ...
                                    <div class="form-group m-l-10">
                                        <label>
                                            <input type="text" class="form-control" name="ems_number" placeholder="物流信息">
                                        </label>
                                    </div>
