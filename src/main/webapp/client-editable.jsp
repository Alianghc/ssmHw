...
<head>
   ...
   <script language="JavaScript">
        $(document).ready(function () {
            ...
            console.log("test client-editable log")
    ...
    <body>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped" id="datatable-editable">
                            ...
                            <tbody>
                               <c:forEach items="${sessionScope.allClients}" var="aClient">
                                <tr>
                                    <td>${aClient.name}</td>
                                    <td>${aClient.sex}</td>
                                    <td>${aClient.email}</td>
                                    ...
                                    <td>${aClient.birth}</td>
                                    <td class="actions">
                                        <a href="/client/save" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                ...
                <div class="panel-body">
                    ...
                    <div class="row m-t-20">
                        <div class="col-md-12 text-right">
                            <button id="dialogConfirm" class="btn btn-primary"><a href="/client/delete"></a>Confirm</button>
        ...
        <script src="assets/jquery-datatables-editable/clientdatatables.editable.init.js"></script>
