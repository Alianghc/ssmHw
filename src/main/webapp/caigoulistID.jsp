                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">请输入新增采购菜单所属合同id</h3></div>
                            <div class="panel-body">
                            
                                <form class="form-inline" action="/orderGoods/findOne" role="form">
                                    <div class="form-group">
                                        <label>
                                            <input type="text" class="form-control" name="orderID" placeholder="所属合同id">
                                        </label>
                                    </div>
                                     <button type="submit" class="btn btn-success m-l-10" data-toggle="modal" data-target=".bs-example-modal-sm">确认</button>
                                </form>
                            </div> <!-- panel-body -->
                        </div> <!-- panel -->
                    </div> <!-- col -->
