                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">添加合同</h3></div>
                            <div class="panel-body">
                                <form action="/order/save" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="date" id="example-email" name="date" class="form-control" placeholder="日期">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <label>
                                                    <input name="state" type="text" class="form-control" disabled="" value="未执行">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <label>
                                                    <input name="client_email" type="email" class="form-control"  placeholder="Email">
                                                </label>
                                            </div>
                                        </div>
                                    <div class="form-group">
                                    ...
                                    <c:forEach items="${sessionScope.allGoods}" var="aGoods" varStatus="status">
                                        <tr>
                                            <td>
                                                <label>
                                                    <input  name="orderGoods[${status.count-1}].goods_name" type="text" class="form-control" value="${aGoods.goods_name}" readonly >
                                                </label>
                                            </td>
                                            <td>
                                                <label>
