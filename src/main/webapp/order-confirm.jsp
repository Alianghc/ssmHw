...
<head>
    ...
    <script language="JavaScript">
        $(document).ready(function () {
            $.ajax({
                url: "http://localhost:8080/clientPurchaseOrder/findAll",
                type: "POST",
                async:false
            });
    ...
    <body>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped" id="datatable-editable">
                            ...
                            <tbody>
                               <c:forEach items="${sessionScope.weifukuan}" var="acpOrder">
                                <tr>
                                    <td>${acpOrder.id}</td>
                                    <td>${acpOrder.date}</td>
                                    <td>${acpOrder.address}</td>
                                    <td>${acpOrder.state}</td>
                                    <td>${acpOrder.sum}</td>
                                    <td>${acpOrder.order_id}</td>
                                    <td class="actions">
                                       <a href="clientPurchaseOrder/confirm?id=${acpOrder.id}" class="on-default save-row"><i class="fa fa-save"></i></a>
                                    </td>
                                </tr>
                                </c:forEach>
                               <c:forEach items="${sessionScope.yifukuan}" var="acpOrder">
                                   <tr>
                                       <td>${acpOrder.id}</td>
                                       <td>${acpOrder.date}</td>
                                       <td>${acpOrder.address}</td>
        ...
        <script src="assets/jquery-datatables-editable/orderconfirmdatatables.editable.init.js"></script>
