...
<head>
    ...
    <script >
        $(document).ready(function () {
            ...
            const msg = "<%=session.getAttribute("saleYejiMsg")%>";
            console.log(msg);
            if(!(msg==="null")){
                alert(msg);
                <%session.removeAttribute("saleYejiMsg");%>
            }
        })
    </script>
    </head>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">某段时间内您的销售额</h3></div>
                            <div class="panel-body">
                            
                                <form class="form-inline" action="/order/findSaleYeji" role="form">
