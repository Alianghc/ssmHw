...
<head>
    ...
    <body>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="m-b-30">
                                    <button  class="btn btn-primary waves-effect waves-light" onclick="window.location.href='hetong-add.jsp'">Add <i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped" id="datatable-editable">
                            ...
                            <tbody>
                               <c:forEach items="${sessionScope.allOrder}" var="aOrder">
                                <tr>
                                    <td>${aOrder.id}</td>
                                    <td>${aOrder.date}</td>
                                    ...
                                    <td>${aOrder.state}</td>
                                    <td>${aOrder.sum}</td>
                                    <td>${aOrder.client_email}</td>
                                    <td>${aOrder.salesman_id}</td>
                                    <td class="actions">
                                        <a href="order/findOne?id=${aOrder.id}" class="on-default "><i class="fa fa-pencil"></i></a>
        ...
        <script src="assets/jquery-datatables-editable/orderdatatables.editable.init.js"></script>
